...
- [ ] **P0b** — Split image-import maps (gallery vs detail/carousel); drop `dev`.
- [ ] **P1a** — Add AVIF to imagetools profiles.
- [ ] **P1b** — Lower carousel `INSTANCE_COUNT` 5→3.
- [ ] **P2a** — Precompute lightbox dimensions; stop runtime probing.
